...
export function StatCounter({ value, suffix = '', label, durationMs = 1200 }: StatCounterProps) {
  ...
  return (
    <div
      ref={ref}
      className="border border-border rounded-lg bg-surface px-5 py-6 hover:border-border-strong transition-colors"
    >
